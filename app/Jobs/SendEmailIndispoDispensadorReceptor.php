...
use Mail;
use Excel;
use App\Imports\IndispoDispensadorReceptorImport;

class SendEmailIndispoDispensadorReceptor implements ShouldQueue
{
    ...
    public function handle(Request $request)
    {
        try {
            ...
            Excel::import(new IndispoDispensadorReceptorImport, $file);
            DB::select("DELETE from  indispo_dispensador_mas_receptor where LENGTH(atm) >4;");
            DB::select("UPDATE indispo_dispensador_mas_receptor set atm= LPAD(atm,4,'0');");
