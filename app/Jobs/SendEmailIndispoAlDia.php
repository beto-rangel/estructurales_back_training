...
use Mail;
use Excel;
use App\Imports\IndispoAlDiaImport;

class SendEmailIndispoAlDia implements ShouldQueue
{
    ...
    public function handle(Request $request)
    {
        try {
            ...
            Excel::import(new IndispoAlDiaImport, $file);

            DB::select("DELETE from  indisp_al_dia where LENGTH(ATM) >4;");
            DB::select("UPDATE indisp_al_dia set ATM= LPAD(ATM,4,'0');");
