...
use Mail;
use Excel;
use App\Imports\DetalleFallasImport;

class SendEmailCargaDetalleFallas implements ShouldQueue
{
    ...
    public function handle(Request $request)
    {
        try {
            ...
            Excel::import(new DetalleFallasImport, $file);
            

            DB::select("DELETE from  detalle_fallas where LENGTH(__IDAtm) >4;");
            DB::select("UPDATE detalle_fallas set __IDAtm= LPAD(__IDAtm,4,'0');");
        ...
        $data_for_email = [
            ...
            return JsonResponse::singleResponse(["message" => "Excel Detalle Fallas guardadas correctamente: " ]);
