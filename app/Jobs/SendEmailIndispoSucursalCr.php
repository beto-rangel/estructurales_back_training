...
use Mail;
use Excel;
use App\Imports\IndispoSucursalCrImport;

class SendEmailIndispoSucursalCr implements ShouldQueue
{
    ...
    public function handle(Request $request)
    {
        try {
            ...
            Excel::import(new IndispoSucursalCrImport, $file);
            DB::select("DELETE from  indispo_sucursal_cr where LENGTH(cr) >4;");
            DB::select("UPDATE indispo_sucursal_cr set cr= LPAD(cr,4,'0');");
